...
from gta.modules import common_util, string_util

###########################################################################################

def get_file_name(file_path: str, rm_ext_flag: bool) :
...
def get_file_paths(in_path: str, inner_flag: bool) :
    file_paths = []
...
>>>>>>> 3f182e701103daa37bbdc2f462a406e323160b9a
    file = open_file(out_file_path, encoding, 'w')
