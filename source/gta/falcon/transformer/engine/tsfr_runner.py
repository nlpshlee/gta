...
from gta.falcon.transformer.engine.tsfr_core import TSFRCore
...
if __name__ == "__main__" :
    home_dir = 'C:/nlpshlee/dev_env/git/repos/gta'
    conf_path = os.path.join(home_dir, 'conf/falcon/tsfr_conf.json')
    res_dir = os.path.join(home_dir, 'resources/falcon/transformer/')
    encoding = "utf8"
    training_flag = True
